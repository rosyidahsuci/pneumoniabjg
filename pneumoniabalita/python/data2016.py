...
# df = pd.DataFrame(dataset, columns=["jumlah_balita", "jumlah_penderita", "penderita_ditangani"])
...
# data nama kecamatan
cur.execute("SELECT nama_kecamatan from kecamatans order by id")
